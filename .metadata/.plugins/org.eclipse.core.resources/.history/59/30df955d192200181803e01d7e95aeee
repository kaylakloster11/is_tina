...
//!
//! \param bEthernet is a uint8_tean used to determine function of Ethernet pins.
//! If true Ethernet pins are  configured as Ethernet LEDs.  If false GPIO are
//! available for application use.
//! \param bUSB is a uint8_tean used to determine function of USB pins. If true USB
...
//*****************************************************************************
void
PinoutSet(uint8_t bEthernet, uint8_t bUSB)
{
    //
